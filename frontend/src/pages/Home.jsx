        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-100 text-cyan-700 rounded-full text-sm font-medium mb-6">
              ...
              Learn Cybersecurity Through CTF Challenges
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
              Explore the exciting world of cybersecurity through hands-on CTF challenges.
              Learn forensics, cryptography, web exploitation, and more.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-8 border border-slate-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-slate-600">CTF Categories</p>
          </div>
          <div className="bg-white rounded-2xl p-8 border border-slate-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-slate-600">Practice Challenges</p>
          </div>
          <div className="bg-white rounded-2xl p-8 border border-slate-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-slate-600">Always Free to Use</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Explore different areas of cybersecurity and test your skills
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mb-20">
        <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl shadow-cyan-600/30">
          ...
          <p className="text-cyan-100 text-lg mb-8 max-w-2xl mx-auto">
            Begin with easy challenges and progressively build your cybersecurity skills
          </p>
          <Link to="/categories">
